...
if __name__ == "__main__":
    ...
    parser.add_argument("--target-model-path",  type=str, default="/nas03/xiaofei/fschat/FastChat/Llama-3-8B-Instruct-lora")
    parser.add_argument("--lora-path", type=str, default="/nas03/xiaofei/fschat/FastChat/checkpoints_llama3_instruct_8b/checkpoint-6000",)
